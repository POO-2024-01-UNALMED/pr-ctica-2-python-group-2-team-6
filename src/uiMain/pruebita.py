...
class TestApp:
    def __init__(self, root):
        root.title("Prueba de FieldFrame")
        root.geometry("500x400")
        
        # Crear un FrameField con criterios y valores de prueba
        criterios = ["Nombre", "Edad", "Ciudad"]
        valores = ["Juan", "30", "Madrid"]
        
        # Crear el FieldFrame con tipo 1 para probar "Sí" o "No"
        self.field_frame = FieldFrame(root, "Criterios", criterios, "Valores", valores, tipo=1)
        self.field_frame.pack(padx=20, pady=20)
        
        # También podrías probar con otros tipos de FieldFrame, por ejemplo:
        # self.field_frame = FieldFrame(root, "Criterios", criterios, "Valores", valores, tipo=0)
